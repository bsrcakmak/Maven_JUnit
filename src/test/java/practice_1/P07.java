...
public class P07 {
    ...
    public void setUp() throws Exception {
        ...
        driver = new ChromeDriver();   // Bos bir browser acar
    ...
    public void test01() {
        ...
        // Bulunan sonuc sayisini yazdirin
        String[] aramaSonucSayisi = driver.findElement(By.xpath("//*[@id='result-stats']")).getText().split(" ");
        String sonuc = aramaSonucSayisi[1];
        System.out.println("Sonuc Sayisi : " + sonuc);

        // sonuc sayisinin 10 milyon’dan fazla oldugunu test edin
        sonuc = sonuc.replaceAll("\\D", "");  // ReplaceAll methodu ile \\D'i kullanarak butun noktalama isaretlerini kaldirabiliriz
