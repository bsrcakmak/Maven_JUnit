...
public class P02 {
    public static void main(String[] args) {
        ...
        firstname.sendKeys("Busra",   // first name
                Keys.TAB,"Cakmak",  // last name
        ...
        // Keys.TAB --> alt satira geciyor
        // Keys.ARROW_RIGHT --> sagdaki secenege kayiyor
        // Keys.SPACE --> bos kutuyu isaretler
