...
public class HWActions01 extends TestBase {
    ...
    public void test() {
        ...
        // actions.moveToElement(kutu).perform();  --> istenen locate'e kadar sayfayi asagi indirir
        actions.sendKeys(Keys.PAGE_DOWN).perform(); // --> buda sayfayi bir miktar asagi indirir
        ...
        List<String> allWindow = new ArrayList<>(driver.getWindowHandles());  // --> yeni pencere acildigi icin
        driver.switchTo().window(allWindow.get(1));  // acilan 1. indexli pencereye gectik
