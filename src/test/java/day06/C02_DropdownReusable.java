...
public class C02_DropdownReusable {
    ...
    public void selectFromDropdown(WebElement dropdown, String secenek){
        ...
        // selectFromDropdown(driver.findElement(By.xpath("//select[@id='day']")), "12"); --> day den 12

        // Gonderilen dropdown elementinin tum options'lari alinir
      List<WebElement> options = dropdown.findElements(By.tagName("option")); // Tum option tag'li elemetleri gonder
